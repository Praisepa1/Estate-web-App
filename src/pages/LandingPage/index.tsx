  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-markoone sm:gap-10 md:gap-10 gap-[100px] items-center justify-start mx-auto w-auto sm:w-full md:w-full">
            ...
            <div className="flex flex-1 flex-col items-start justify-start w-full">
              <div className="sm:gap-5 gap-6 grid sm:grid-cols-1 grid-cols-2 justify-center min-h-[auto] w-full">
                {new Array(4).fill({}).map((props, index) => (
                  <React.Fragment key={`SearchLocation${index}`}>
                    <SearchLocation
                      className="bg-deep_orange-50 flex flex-1 flex-col gap-2 h-[200px] md:h-auto items-start justify-center sm:px-5 px-[30px] py-6 rounded-[20px] w-full"
                      {...props}
                    />
                  </React.Fragment>
                ))}
        ...
        <div className="bg-gray-50 flex flex-col font-manrope md:grid md:grid-cols-2 md:grid-rows-2 items-start justify-start md:px-10 sm:px-5 px-[120px] py-[50px] w-full">
          <div className="flex md:flex-col flex-row md:gap-10 gap-[100px] items-start justify-start max-w-[1200px] mx-auto w-full">
            ...
            >
              {new Array(3).fill({}).map((props, index) => (
                <React.Fragment key={`Users${index}`}>
                  <Users
            ...
            <Users className="flex flex-1 flex-col gap-[18px] items-start justify-start w-full" />
          </div>
        </div>
        ...
        <div className="bg-gray-900 flex flex-col font-manrope items-center justify-center p-[120px] md:px-10 sm:px-5 w-full">
          <div className="flex flex-col md:gap-10 gap-[120px] items-center justify-start max-w-[1200px] mx-auto w-full">
            <div className="flex flex-col md:gap-10 gap-[60px] items-start justify-start w-full">
              ...
              >
                {new Array(3).fill({}).map((props, index) => (
                  <React.Fragment key={`NewsAndConsult${index}`}>
                    <NewsAndConsult
                      className="flex flex-1 flex-col gap-6 h-[487px] md:h-auto items-start justify-start w-full"
                      {...props}
                    />
                  </React.Fragment>
                ))}
