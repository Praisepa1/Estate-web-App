            ...
            <div className="flex flex-col items-start justify-start w-full">
              <div className="flex flex-col gap-10 items-start justify-start w-full">
                ...
                <div className="flex flex-col gap-[25px] items-start justify-center sm:px-5 px-[25px] w-full">
                  ...
                  >
                    <Review className="bg-white-A700 border border-bluegray-100 border-solid flex flex-1 flex-col gap-2 items-start justify-start sm:px-5 px-[30px] py-[39px] rounded-[20px] w-full" />
